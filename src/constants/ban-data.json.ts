...
type Description = string | { description: string; link: string };
...
const banData: Record<string, Data> = {
    ...
    laws: [
      {
        ...
        note: [
          ...
          {
            description:
              "The law was enforced during demonstrations in 2017-2018.",
            link: "https://www.al.com/news/2020/04/alabama-authorities-urge-people-to-ignore-kkk-era-anti-masking-law.html",
          },
        ],
      },
  ...
  "New York": {
    laws: [
      ...
      },
      {
        ...
        repealedDate: 2020,
        repealedDescription:
          "The law was repealed by the state legislature in 2020. The pre-COVID law was used against Occupy Wall Street protestors in 2011 and even trans people who were considered to be “masquerading” in disguise.",
        description:
  ...
  "North Carolina": {
    laws: [
      {
        status: "Active",
        enactedDate: { month: 6, year: 2024 }, // June 2024
        effectiveDate: { month: 10, year: 2024 }, // October 2024
  ...
  "South Carolina": {
    ...
    note: {
      description:
        "Failed attempts to amend the state law in 2022-2023 allowing for a health exemption but only during a “lawfully declared” public emergency.",
  ...
  Tennessee: {
    ...
    note: {
      description: "Failed bill in January 2020 for masking during protest.",
      link: "https://www.icnl.org/usprotestlawtracker/?location=&status=&issue=5&date=&type=",
    },
  },
  Texas: {
  ...
  Virginia: {
    ...
    note: {
      description:
        "The City of Alexandria tried to ban ski masks in housing developments in November 2023, but the police and public pushed back.",
  ...
  Wisconsin: {
    ...
    note: {
      link: "https://www.icnl.org/usprotestlawtracker/?location=&status=&issue=5&date=&type=",
      description: "failed bill criminalizing masking in public space in 2019.",
    },
  },
  Wyoming: {
    laws: [],
...
export type BanData = keyof typeof banData;
