import type { BanStatusType, RegionType } from "@/db/schema";

type Reference = { text: string; link?: string };

type NotableDate = { month?: number; year: number };

type Penalty = {
  jail?: { min?: number; max: number };
...
type BanCommon = {
  region: { name: string; type: RegionType };
  description: string;
  condition: string;
  penalties?: Penalty[];
  notes?: Reference[];
...
type BanEnacted = BanCommon & {
  status: "enacted";
  enactedDate?: NotableDate;
...
type Ban<Status extends BanStatusType = BanStatusType> =
  Status extends "enacted"
    ? BanEnacted
    : Status extends "proposed"
      ? BanProposed
      : Status extends "repealed"
        ? BanRepealed
        : never;
...
const banData: Record<string, Data> = {
  "Federal Government": {
    laws: [
      {
        region: { name: "Federal Government", type: "country" },
        status: "proposed",
        proposedBy: "all",
        ...
        penalties: [
          {
            jail: { max: 180 }, // 15 years
          },
        ],
      },
      {
        status: "proposed",
        region: { name: "Alabama", type: "state" },
        proposedBy: "all",
        link: "https://www.congress.gov/bill/118th-congress/house-bill/8248?q=%7B%22search%22%3A%228248%22%7D&amp;s=2&amp;r=1",
        proposedDate: {
          month: 5, // May
  ...
  Arizona: {
    laws: [
      {
        region: { name: "Arizona", type: "state" },
        status: "enacted",
        link: "https://www.azleg.gov/ars/13/00701.htm",
        enactedDate: { year: 2018 },
        ...
        notes: [
          {
            text: "These enhanced penalties were passed after state Republicans failed to pass two bills in 2017 to heighten penalties for people wearing masks during an 'unlawful assembly or a riot.'",
          },
        ],
      },
    ],
  ...
  Connecticut: {
    laws: [
      {
        region: { name: "Connecticut", type: "state" },
        status: "enacted",
        ...
        penalties: [
          {
            ...
            jail: { max: 12 }, // Up to one year
            fine: { max: 3_000 }, // "Up to $3,000",
          },
        ],
      },
    ],
    ...
    laws: [
      {
        ...
        notes: [
          {
            text: "D.C. had a pre-COVID law, enacted in 1983, which was similar. It was repealed in 2020.",
          },
        ],
      },
    ],
  ...
  Georgia: {
    laws: [
      {
        region: { name: "Georgia", type: "state" },
        status: "enacted",
        ...
        penalties: [
          {
            ...
            jail: { max: 12 }, // "Up to a year",
            fine: { max: 1_000 }, // "Up to $1,000",
          },
        ],
        notes: [
          {
  ...
  Kansas: {
    ...
    notes: [
      {
        text: "Bill in 2018 died in committee, which would have made it illegal to conceal one’s identity during a public demonstration.",
      },
    ],
  },
  Kentucky: {
  ...
  Massachusetts: {
    laws: [
      {
        region: { name: "Massachusetts", type: "state" },
        status: "enacted",
        ...
        penalties: [
          {
            jail: { max: 12 }, // "Up to one year",
            fine: { max: 500 }, // "Up to $500",
          },
        ],
        notes: [
          {
            text: "often missed on lists of mask bans because it doesn't mention masks, it mentions disguises.",
          },
        ],
      },
    ],
  ...
  Minnesota: {
    laws: [
      {
        region: { name: "Minnesota", type: "state" },
        status: "enacted",
        link: "https://www.revisor.mn.gov/statutes/cite/609.735",
        condition: "general ban with medical and other exemptions",
        enactedDate: { year: 1963 },
        description:
  ...
  "New Mexico": {
    laws: [
      {
        region: { name: "New Mexico", type: "state" },
        status: "enacted",
        enactedDate: { year: 1953 },
  ...
  "New York": {
    laws: [
      {
        ...
        enactedDate: { month: 8, year: 2024 }, // August 2024
        description:
      ...
      {
        region: { name: "New York", type: "state" },
        status: "proposed",
        proposedDate: { month: 5, year: 2024 }, // May 2024
        proposedBy: "Democratic",
      ...
      },
      {
        ...
        notes: [
          {
            text: "The bill includes an additional crime of “aggravated deceptive wearing of a mask,” if property damage or injuries occur while in a public assembly, with exemptions for religious purposes and permitted celebrations.",
          },
        ],
      },
      {
    ...
    notes: [
      {
        text: "notes: Governor Kathy Hochul and New York City Mayor Eric Adams have both made statements indicating their interest in banning masks — for Hochul, on subways (and not protests) and for Adams, in general.",
  ...
  "North Carolina": {
    laws: [
      {
        region: { name: "North Carolina", type: "state" },
        status: "enacted",
        enactedDate: { year: 2024 }, // enacted June 2024, Effective October 2024
        ...
        notes: [
          {
            text: "The pre-COVID law had a stronger medical exemption: “for the purpose of ensuring the physical health or safety of the wearer or others.” And it only permitted police to request mask removal at a traffic stop or when they believed a crime was taking place.",
          },
        ],
      },
    ],
  ...
  "North Dakota": {
    laws: [
      {
        region: { name: "North Dakota", type: "state" },
        status: "enacted",
        enactedDate: { year: 2017 },
        description:
        ...
        penalties: [
          {
            ...
            fine: { max: 5_000 }, // "Up to $5,000",
          },
        ],
        notes: [
          {
            text: "The Ohio Attorney General threatened to use the law in 2024 against college protestors. There was also a failed bill in 2019 to criminalize masking during protests.",
  ...
  Oklahoma: {
    laws: [
      {
        region: { name: "Oklahoma", type: "state" },
        status: "enacted",
        enactedDate: { year: 1923 },
        description:
  ...
  Pennsylvania: {
    laws: [],
    notes: [{ text: "Philadelphia passed a ban on ski masks in 2024" }],
  },
  "Rhode Island": {
    laws: [],
  },
  "South Carolina": {
    laws: [
      {
        region: { name: "South Carolina", type: "state" },
        status: "enacted",
        enactedDate: { year: 1951 },
  ...
  Tennessee: {
    laws: [
      {
        region: { name: "Tennessee", type: "state" },
        status: "enacted",
        enactedDate: { year: 1868 },
      ...
      {
        status: "enacted",
        region: { name: "Knoxville", type: "city" },
  ...
  Texas: {
    laws: [],
    notes: [{ text: "Past mask ban from 1925 was repealed in 1974" }],
  },
  Utah: {
    laws: [],
  },
  ...
  Virginia: {
    laws: [
      {
        region: { name: "Virginia", type: "state" },
        status: "enacted",
        enactedDate: { year: 1950 },
        description:
  ...
  "West Virginia": {
    laws: [
      {
        region: { name: "West Virginia", type: "state" },
        status: "enacted",
        enactedDate: { year: 1988 },
        description:
